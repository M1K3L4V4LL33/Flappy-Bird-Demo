...
<<<<<<< HEAD
        ...
        setPaintOrder( Score.class, GameOver.class, BottomPipe.class, TopPipe.class, FlappyBurd.class);
    ...
    private void populateWorld()
    {
        ...
        addObject( new FlappyBurd(), 50, getHeight()/2 );
    ...
    public void act()
    {
        ...
        if( gameStart == false )
        {
            ...
            showText( "Get ready to fly my Dude!!!!!\nUse the Space Bar to Control this Burd", getWidth()/2, getHeight()/2 );
            Greenfoot.delay(100);
        ...
        {
            if( getObjects( FlappyBurd.class ).size() > 0 )
            {
                pipeCounter++;
    ...
    /**
     * craetePipes adds pipes at the edge of the world and randomizes their height 
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
    ...
    /**
     * reset Resets the game and allow to play a new game
     * 
     * @param There are no parameters
     * @return Nothing is returned
     */
